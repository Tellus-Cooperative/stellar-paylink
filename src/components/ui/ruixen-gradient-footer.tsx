...
// Ruixen Gradient Footer. Its content reads first; the blurred rainbow is
// pinned to the bottom of the viewport and stretches up from the floor over
// the last stretch of scroll, hitting full height exactly when you reach the
// end of the page. One inline SVG, no canvas, no giant scroll spacer.
//
...
export function RuixenGradientFooter({
  ...
  return (
    ...
    >
      ...
      {/* ponytail: pinned to the viewport. A transformed or filtered ancestor
