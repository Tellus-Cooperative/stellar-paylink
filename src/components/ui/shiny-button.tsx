  ...
  return (
    <>
      <style jsx>{`
        ...
        .shiny-cta {
          --shiny-cta-bg: #050f10;
          --shiny-cta-bg-subtle: #0f2a2c;
          --shiny-cta-fg: #ece0cc;
          --shiny-cta-highlight: #3f8487;
          --shiny-cta-highlight-subtle: #7ed8d5;
          ...
          font-family: var(--font-orbit-sans), sans-serif;
          font-size: 1rem;
          line-height: 1.2;
          font-weight: 500;
      ...
      <button className={`shiny-cta ${className}`} onClick={onClick} disabled={disabled} type={type}>
        <span>{children}</span>
      </button>
    </>
  )
