...
- [ ] Clean-room con tester externo y tag `v0.1.0` (release day 16 Sep: dar el README a alguien sin contexto del proyecto, clonar/desplegar/pagar; luego tag + release notes + anuncio). Preparado el 2026-09-12: aviso experimental/Testnet/no-auditado visible en footer de landing y app (`f50bf70`), milestone `v0.2.0` y 8 starter issues abiertos (#1–#8), anuncio redactado en `ANNOUNCEMENT.md` (se publica tras el clean-room; borrar este archivo del repo al publicarlo en blog/newsletter).
